...
class ActorNetwork(nn.Module):
    ...
    A network for actor
    Args :
    state_dim : last dimensions of state
    hidden_size : dimension of hidden layer
    output_act : activation function for the output

    Returns : probabilities for various actions
    """
...
class CriticNetwork(nn.Module):
    ...
    Same as actor. But in hiden layer, We are concating the output with action along 2nd dimension.
    Args :
    state_dim : last dimensions of state
    hidden_size : dimension of hidden layer
    output_act : activation function for the output (by default size 1, as critic gives score to given actor's actions)
